...
//            _scrollView.contentInset = inset;
        ...
        [UIView transitionWithView:_scrollView
                        ...
                        animations:^{
                            UIEdgeInsets inset = _scrollView.contentInset;
                            inset.top = _upInset + insertOffset;
                            _scrollView.contentInset = inset;
                            ...
                            //_notSetFrame = NO;
                            if (ISIOS7) {
                                _scrollView.contentInset = UIEdgeInsetsMake(_upInset + insertOffset, 0, 0, 0);
                                _scrollView.contentOffset = CGPointMake(0, -insertOffset);
                            }
