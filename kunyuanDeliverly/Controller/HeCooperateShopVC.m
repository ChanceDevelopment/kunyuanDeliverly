...
@interface HeCooperateShopVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation HeCooperateShopVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *cellIndentifier = @"HeCoorperateShopCell";
    ...
    HeCoorperateShopCell *cell  = [tableView cellForRowAtIndexPath:indexPath];
    if (!cell) {
        cell = [[HeCoorperateShopCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIndentifier cellSize:cellSize];
