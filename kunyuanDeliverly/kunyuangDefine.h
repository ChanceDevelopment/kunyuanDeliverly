...
#define BAIDUMAPKEY @"Cm8SfWG8HcjFW1hxu8lfNUb3rFn1uZBe"
//自己服务器的通信模块
...
#define EMPTYSTRING @"     : "
//默认绿色的RGB
#define APPDEFAULTORANGE ([UIColor colorWithRed:53.0 / 255.0 green:145.0 / 255.0 blue:224.0 / 255.0 alpha:1.0])
//默认标题颜色
